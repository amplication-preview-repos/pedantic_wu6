...
const CREATE_INPUT = {
  ...
  createdAt: new Date(),
  id: "exampleId",
  medicalIssue: "exampleMedicalIssue",
  updatedAt: new Date(),
};
const CREATE_RESULT = {
  appointmentDateTime: new Date(),
...
describe("Appointment", () => {
  ...
  test("POST /appointments", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...CREATE_RESULT,
        appointmentDateTime: CREATE_RESULT.appointmentDateTime.toISOString(),
      ...
      .expect([
        {
          ...FIND_MANY_RESULT[0],
          appointmentDateTime:
            FIND_MANY_RESULT[0].appointmentDateTime.toISOString(),
  ...
  test("GET /appointments/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...FIND_ONE_RESULT,
        appointmentDateTime: FIND_ONE_RESULT.appointmentDateTime.toISOString(),
